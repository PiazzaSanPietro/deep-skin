...
from skin_model import FACEPART_TO_TRUNK, LABEL_REGISTRY
...
_DEFAULT_HEAD_CKPT = _SCRIPT_DIR.parent.parent / "model" / "face_multivalue_inf_best.pt"
_DEFAULT_DINOV3_CKPT = _SCRIPT_DIR.parent / "dinov3_vits16plus_pretrain_lvd1689m-4057cbaa.pth"


def _main():
    import argparse, json
    p = argparse.ArgumentParser()
    p.add_argument("--head_checkpoint", default=str(_DEFAULT_HEAD_CKPT))
    p.add_argument("--dinov3_checkpoint", default=str(_DEFAULT_DINOV3_CKPT))
